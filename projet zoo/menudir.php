...
<body>
	...
	<nav align="center">
		...
		<ul>
			<li class="menu-directeur"><a href="menudir.php">acceuil</a></li>
			</li>	
			...
			<li class="menu-directeur"><a href="#">gestion personnels </a>
                <ul class="submenu">  
			        <li><a target="f" href="formulaire.html">Ajout personnels</a></li>	
			        <li><a target="f" href="rechemp.php">Recherche personnels</a></li>
			        <li><a target="f" href="modifemp.php">Modifier personels</a></li>
			        <li><a target="f" href="affsuppemp.php">information personnels</a></li>
				</ul>
			<li class="menu-directeur"><a href="logout.php">déconnection</a></li>
			<li class="menu-directeur"><a href="http://localhost/wordpress/projet/">Retour portefelio</a></li>
			</li>						
		</ul>
	</nav>
